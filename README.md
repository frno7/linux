...
The wiki has a guide on [building and installing PlayStation 2 Linux](https://github.com/frno7/linux/wiki/Building-and-installing-PlayStation-2-Linux).

## PlayStation 2 Linux distributions

A modern [Gentoo Linux](https://gentoo.org/) can be compiled for the R5900 and the PlayStation 2. The wiki has a guide on [Gentoo Linux for the PlayStation 2](https://github.com/frno7/linux/wiki/Gentoo-Linux-for-the-PlayStation-2).
