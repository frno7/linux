...
SYSFS_RW_REG(smode1, smode1,
	...
	/*
	 * FIXME: GCC bugs on more fields:
	 *
	 * arch/mips/ps2/gs-sysfs.c: In function ‘show_smode1’:
	 * arch/mips/ps2/gs-sysfs.c:232:15: error: implicit declaration of function ‘SYSFS_STATEMENTSYSFS_DECNUM_FIELD’; did you mean ‘SHOW_SYSFS_DECNUM_FIELD’? [-Werror=implicit-function-declaration]
	 *    CONCATENATE(SYSFS_STATEMENT,    \
	 *                ^~~~~~~~~~~~~~~
	 * arch/mips/ps2/gs-sysfs.c:226:3: note: in definition of macro ‘SHOW_SYSFS_REGISTER’
	 *    __VA_ARGS__;      \
	 *    ^~~~~~~~~~~
