			   ...
			   enum tlb_write_entry wmode)
{
	...
	case CPU_R5900:
		 ...
		 * followed by an ERET or a SYNC.P instruction to ensure
		 * TLB update (Toshiba TX79 manual pp. C-39, C-40).
		 */
		tlbw(p);
		uasm_i_syncp(p);
		break;
...
static void build_r4000_tlb_refill_handler(void)
{
	...
	dump_handler("r4000_tlb_refill", (u32 *)ebase, (u32 *)(ebase + final_len));
}
