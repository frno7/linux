...
/* Status bits for the sub-to-main (SM) and main-to-sub (MS) SIF registers. */
...
#define SIF_CMD_RPC_IRQ		(SIF_CMD_ID_USR | 0x20)

#define SIF_SID_FILE_IO		(SIF_CMD_ID_SYS | 0x01)
